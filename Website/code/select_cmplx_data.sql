...
insert into params (pr_id,pr_name,pr_code) values (1,'No. of cycles to select for','ncycles');
insert into params (pr_id,pr_name,pr_code) values (2,'Current cycle of selection','currcycle');
insert into params (pr_id,pr_name,pr_code) values (3,'No. of Dams per Sire','dams2sire');
insert into params (pr_id,pr_name,pr_code,pr_note) values (4,'Age to cull at','cullage','Animals older that this age will not appear in selection lists.');
insert into params (pr_id,pr_name,pr_code,pr_note) values (5,'Age at birth','mateage','The parents age when its first progeny is born.');
insert into params (pr_id,pr_name,pr_code,pr_note) values (6,'Allele frequencies','allelefreq','Values must sum to zero.');
insert into params (pr_id,pr_name,pr_code,pr_class) values (7,'Relative Economic Values (REVs)','objectvrevs','controlset');
insert into params (pr_id,pr_name,pr_code,pr_class) values (8,'Select using','selnmeth','controlset');
insert into params (pr_id,pr_name,pr_code,pr_class) values (9,'Summarise','summtype','controlset');
insert into params (pr_id,pr_name,pr_code,pr_note) values (10,'Traits to select on','trts2select','These traits will be available in your selection lists');
insert into params (pr_id,pr_name,pr_code,pr_note) values (11,'Traits to summarise','trts2summ','These traits will be summarised in your final population report');
insert into params (pr_id,pr_name,pr_code) values (12,'Traits to record','trtsrecorded');
insert into params (pr_id,pr_name,pr_code,pr_note) values (13,'No. of breeding females','popsizes','This does not include female replacements that are too young to mate');
