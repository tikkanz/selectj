...
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Sheep Production','117.352','All about sheep production including genetics',1);
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Animal Breeding and Genetics','227.202','Genetics for vets',1);
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Genetics for Livestock Improvement','117.345','All about genetics',1);
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Principles of Animal Production','117.254','Animal Production including genetics',1);
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Experiment with AnimalSim','AnSim','Course for guests to play with AnimalSim',1);
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Production Animal Science','ASC101','Intro course with genetics',2);
insert into courses (cr_name, cr_code, cr_descr, crinid) values ('Using Genetics','USEGEN','Extension for farmers',3);

insert into offerings (of_crid, of_year, of_smid, of_dmid) values (1,2007,1,1);
insert into offerings (of_crid, of_year, of_smid, of_dmid) values (1,2007,1,1);
...
insert into enrolments (en_urid, en_ofid, en_rlid) values ();

insert into templates (tm_sdid, tm_opt1, tm_opt2, tm_opt3) values ();

insert into templatetext (tt_tmid, tt_intro, tt_instruct, tt_btwncycle, tt_conc) values ();
insert into templatetext (tt_tmid, tt_intro, tt_instruct, tt_conc) values ();

insert into offeringtemplates (ot_ofid, ot_tmid) values ();
