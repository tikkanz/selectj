...
<!-- end masthead --><div id="breadCrumb"><!-- InstanceBeginEditable name="breadCrumb" --><span class="current">Login </span><!-- InstanceEndEditable --> </div>
	  ...
	  Login
		...
		<tbody>
		  <tr>
		    ...
		    <p><a href="register.jhp" class="register">Create a user account now</a> </p>
            <p><a href="register.jhp?action=guest">Login as Guest</a> </p></td>
		  </tr>
		  <tr>
