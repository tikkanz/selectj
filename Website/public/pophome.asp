...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/default_case.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div id="content"> 
  ...
  <div id="breadCrumb"> <a href="default.jhp?action=logout">Logout</a> | <a href="user.jhp?action=home">myCourses</a> | <a href="course.jhp?action=home">CourseHome</a> | CaseHome</div>
