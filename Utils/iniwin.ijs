...
NB.*getPPAllSections v Gets all the keynames and values in an INI file
...
getPPSection=: 3 : 0
  '#' getPPSection y  NB. default comment delimiter is #
  :
  'fnme snme'=. y
  ...
  val=. <;._1 val
  val=. dtb each x taketo each val
...
getPPAllSections_z_=: getPPAllSections_rgsiniwin_
getPPValue_z_=: getPPValue_rgsiniwin_
getPPVals_z_=: getPPVals_rgsiniwin_
writePPString_z_=: writePPString_rgsiniwin_
makeVals_z_=: makeVals_rgsiniwin_