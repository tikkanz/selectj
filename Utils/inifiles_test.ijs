NB. Tests for inifiles
   ...
   NB. INIPATH fwrites~ freads jpath '~addons/category/inifiles/example.ini'
   freads INIPATH

NB. Test1: test that parseIni and makeIni are inverse of each other
   ini1=. parseIni_rgsini_ freads INIPATH
   ini2=: parseIni_rgsini makeIni_rgsini_ ini1
...
NB. Test8: write change to new INI file
   ...
   res1=: ini1 writeIniString newval;'colors';'Formats';INIPATH2
...
NB. look up multiple keynames at once
   ]keys2get=. ('brkatmodule';'control'),('ColoR';'Formats'),:'Birthdate';'User'
